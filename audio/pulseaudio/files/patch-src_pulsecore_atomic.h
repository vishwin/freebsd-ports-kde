--- src/pulsecore/atomic.h.orig	2020-07-17 10:11:11 UTC
+++ src/pulsecore/atomic.h
@@ -117,7 +117,7 @@ static inline void* pa_atomic_ptr_load(const pa_atomic
 }
...
+    __atomic_store_n(&a->value, (uintptr_t) p, __ATOMIC_SEQ_CST);
 ...
 #else
@@ -217,39 +217,6 @@ static inline bool pa_atomic_ptr_cmpxchg(pa_atomic_ptr
 #include <sys/types.h>
 #include <sys/param.h>
